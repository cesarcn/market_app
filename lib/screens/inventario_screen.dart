...
class InventarioScreen extends StatefulWidget {
  @override
  createState() => _InventarioScreen();
}

class _InventarioScreen extends State<InventarioScreen> {
  @override
  Widget build(BuildContext context) {
    final inventarioProvider = Provider.of<InventarioProvider>(context);
    final List<Inventario> listaInventario = inventarioProvider.listaInventario;
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        itemCount: listaInventario.length,
                    ...
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: FadeInImage(
                            ...
                            image: NetworkImage(listaInventario[index].imagen),
                            fit: BoxFit.cover),
                      ),
                    ),
                    Container(
                      ...
                      child: ListTile(
                        title: Text(
                          listaInventario[index].nomproducto,
                        ...
                        subtitle: Text(
                          listaInventario[index].stock.toString(),
                          style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                              color: Colors.white),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(context, 'ruta_inventario_form');
        },
        backgroundColor: Color.fromARGB(255, 133, 9, 9),
      ),
    );
